...
require __DIR__.'/Container1GjE3xK/srcShopware_Production_KernelDevDebugContainer.php';
...
$classes[] = 'DockwareSamplePlugin\DockwareSamplePlugin';
...
$classes[] = 'DockwareSamplePlugin\Extension\Content\Product\DockwareSampleDefinition';
$classes[] = 'DockwareSamplePlugin\Extension\Content\Product\DockwareSampleExtension';
$classes[] = 'DockwareSamplePlugin\Service\SampleController';
$classes[] = 'DockwareSamplePlugin\Storefront\Controller\SampleController';
$classes[] = 'DockwareSamplePlugin\Subscriber\Storefront\Subscriber';
...
$classes[] = 'Shopware\Core\Checkout\Cart\Price\ReferencePriceCalculator';
...
$classes[] = 'Shopware\Core\Checkout\Cart\SalesChannel\SalesChannelCartController';
$classes[] = 'Shopware\Core\Checkout\Cart\SalesChannel\SalesChannelCheckoutController';
...
$classes[] = 'Shopware\Core\Checkout\Cart\Tax\TaxRuleCalculator';
...
$classes[] = 'Shopware\Core\Checkout\Customer\DataAbstractionLayer\CustomerVatIdsDeprecationUpdater';
...
$classes[] = 'Shopware\Core\Checkout\Customer\SalesChannel\AccountRegistrationService';
...
$classes[] = 'Shopware\Core\Checkout\Customer\SalesChannel\AddressService';
...
$classes[] = 'Shopware\Core\Checkout\Customer\SalesChannel\SalesChannelCustomerController';
...
$classes[] = 'Shopware\Core\Checkout\Shipping\DataAbstractionLayer\ShippingMethodIndexer';
$classes[] = 'Shopware\Core\Checkout\Shipping\DataAbstractionLayer\ShippingMethodPriceDeprecationUpdater';
...
$classes[] = 'Shopware\Core\Content\Cms\SalesChannel\SalesChannelCmsPageController';
...
$classes[] = 'Shopware\Core\Content\ImportExport\Command\DeleteExpiredFilesCommand';
$classes[] = 'Shopware\Core\Content\ImportExport\Service\DeleteExpiredFilesService';
$classes[] = 'Shopware\Core\Content\ImportExport\Command\ImportEntityCommand';
...
$classes[] = 'Shopware\Core\Content\MailTemplate\Aggregate\MailTemplateSalesChannel\MailTemplateSalesChannelDefinition';
...
$classes[] = 'Shopware\Core\Content\MailTemplate\Service\MailSender';
$classes[] = 'Shopware\Core\Content\MailTemplate\Service\MailService';
$classes[] = 'Shopware\Core\Content\MailTemplate\Service\MessageFactory';
...
$classes[] = 'Shopware\Core\Content\Media\Commands\DeleteNotUsedMediaCommand';
$classes[] = 'Shopware\Core\Content\Media\DeleteNotUsedMediaService';
$classes[] = 'Shopware\Core\Content\Media\Commands\GenerateMediaTypesCommand';
$classes[] = 'Shopware\Core\Content\Media\Commands\GenerateThumbnailsCommand';
...
$classes[] = 'Shopware\Core\Content\Newsletter\SalesChannel\SalesChannelNewsletterController';
...
$classes[] = 'Shopware\Core\Content\Product\DataAbstractionLayer\Indexing\ListingPriceUpdater';
...
$classes[] = 'Shopware\Core\Content\Product\DataAbstractionLayer\ProductPurchasePriceDeprecationUpdater';
...
$classes[] = 'Shopware\Core\Content\Product\SalesChannel\CrossSelling\SalesChannelCrossSellingController';
...
$classes[] = 'Shopware\Core\Content\Product\SalesChannel\Listing\ProductListingSortingRegistry';
...
$classes[] = 'Shopware\Core\Content\Product\SalesChannel\Price\ProductPriceDefinitionBuilder';
$classes[] = 'Shopware\Core\Content\Product\SalesChannel\ProductListListRoute';
...
$classes[] = 'Shopware\Core\Content\Seo\Entity\Dbal\SeoUrlJoinBuilder';
...
$classes[] = 'Shopware\Core\Framework\Api\Command\DumpClassSchemaCommand';
$classes[] = 'Shopware\Core\Framework\Api\Command\DumpSchemaCommand';
...
$classes[] = 'Shopware\Core\Framework\App\Command\ActivateAppCommand';
$classes[] = 'Shopware\Core\Framework\App\Command\AppPrinter';
$classes[] = 'Shopware\Core\Framework\App\Command\DeactivateAppCommand';
$classes[] = 'Shopware\Core\Framework\App\Command\InstallAppCommand';
$classes[] = 'Shopware\Core\Framework\App\Command\RefreshAppCommand';
$classes[] = 'Shopware\Core\Framework\App\AppService';
$classes[] = 'Shopware\Core\Framework\App\Lifecycle\AppLifecycleIterator';
$classes[] = 'Shopware\Core\Framework\App\Command\ResolveAppUrlChangeCommand';
$classes[] = 'Shopware\Core\Framework\App\Command\UninstallAppCommand';
$classes[] = 'Shopware\Core\Framework\App\Command\ValidateAppCommand';
$classes[] = 'Shopware\Core\Framework\App\Command\VerifyManifestCommand';
...
$classes[] = 'Shopware\Core\Framework\App\Validation\AppNameValidator';
$classes[] = 'Shopware\Core\Framework\App\Validation\ConfigValidator';
$classes[] = 'Shopware\Core\Framework\App\Validation\HookableValidator';
$classes[] = 'Shopware\Core\Framework\Webhook\Hookable\HookableEventCollector';
$classes[] = 'Shopware\Core\Framework\App\Validation\ManifestValidator';
$classes[] = 'Shopware\Core\Framework\App\Validation\TranslationValidator';
$classes[] = 'Shopware\Core\Framework\Changelog\ChangelogParser';
$classes[] = 'Shopware\Core\Framework\Changelog\Command\ChangelogChangeCommand';
$classes[] = 'Shopware\Core\Framework\Changelog\Processor\ChangelogReleaseExporter';
$classes[] = 'Shopware\Core\Framework\Changelog\Command\ChangelogCheckCommand';
$classes[] = 'Shopware\Core\Framework\Changelog\Processor\ChangelogValidator';
$classes[] = 'Shopware\Core\Framework\Changelog\Command\ChangelogCreateCommand';
$classes[] = 'Shopware\Core\Framework\Changelog\Processor\ChangelogGenerator';
$classes[] = 'Shopware\Core\Framework\Changelog\Command\ChangelogReleaseCommand';
$classes[] = 'Shopware\Core\Framework\Changelog\Processor\ChangelogReleaseCreator';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Cache\EntityCacheKeyGenerator';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Cache\InvalidateCacheSubscriber';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Command\CreateEntitiesCommand';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\EntityGenerator';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Command\CreateSchemaCommand';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\SchemaGenerator';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Command\DataAbstractionLayerValidateCommand';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\DefinitionValidator';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Command\RefreshIndexCommand';
...
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\FieldAccessorBuilder\ListingPriceFieldAccessorBuilder';
...
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\JoinBuilder\ManyToManyJoinBuilder';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\ManyToOneAssociationFieldResolver';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\JoinBuilder\ManyToOneJoinBuilder';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\OneToManyAssociationFieldResolver';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\JoinBuilder\OneToManyJoinBuilder';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\TranslationFieldResolver';
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\Dbal\JoinBuilder\TranslatedJoinBuilder';
...
$classes[] = 'Shopware\Core\Framework\DataAbstractionLayer\FieldSerializer\ListingPriceFieldSerializer';
...
$classes[] = 'Shopware\Core\Framework\Demodata\Command\DemodataCommand';
$classes[] = 'Shopware\Core\Framework\Demodata\DemodataService';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\CategoryGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\CustomFieldGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\CustomerGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\MailHeaderFooterGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\MailTemplateGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\MediaGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\OrderGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\ProductGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\ProductManufacturerGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\ProductReviewGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\ProductStreamGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\PropertyGroupGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\Generator\RuleGenerator';
$classes[] = 'Shopware\Core\Framework\Demodata\PersonalData\CleanPersonalDataCommand';
...
$classes[] = 'Shopware\Core\Framework\Event\Command\DebugDumpBusinessEventsCommand';
...
$classes[] = 'Shopware\Core\Framework\Feature\Command\FeatureDumpCommand';
...
$classes[] = 'Shopware\Core\Framework\MessageQueue\ScheduledTask\Command\RegisterScheduledTasksCommand';
$classes[] = 'Shopware\Core\Framework\MessageQueue\ScheduledTask\Command\ScheduledTaskRunner';
...
$classes[] = 'Shopware\Core\Framework\Migration\Command\CreateMigrationCommand';
$classes[] = 'Shopware\Core\Framework\Migration\Command\MigrationCommand';
$classes[] = 'Shopware\Core\Framework\Migration\Command\MigrationDestructiveCommand';
$classes[] = 'Shopware\Core\Framework\Migration\Command\RefreshMigrationCommand';
...
$classes[] = 'Shopware\Core\Framework\Plugin\Api\PluginController';
$classes[] = 'Shopware\Core\Framework\Plugin\BundleConfigDumper';
$classes[] = 'Shopware\Core\Framework\Plugin\BundleConfigGenerator';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\BundleDumpCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\Lifecycle\PluginActivateCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\Lifecycle\PluginDeactivateCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\Lifecycle\PluginInstallCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\Lifecycle\PluginUninstallCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\Lifecycle\PluginUpdateCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\PluginCreateCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\PluginListCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\PluginRefreshCommand';
$classes[] = 'Shopware\Core\Framework\Plugin\Command\PluginZipImportCommand';
...
$classes[] = 'Shopware\Core\Framework\Routing\SalesChannelApiRouteScope';
...
$classes[] = 'Shopware\Core\Framework\Store\Command\StoreDownloadCommand';
$classes[] = 'Shopware\Core\Framework\Store\Command\StoreLoginCommand';
...
$classes[] = 'GuzzleHttp\Handler\MockHandler';
...
$classes[] = 'Shopware\Core\System\SalesChannel\Command\SalesChannelCreateCommand';
$classes[] = 'Shopware\Core\System\SalesChannel\Command\SalesChannelListCommand';
$classes[] = 'Shopware\Core\System\SalesChannel\Command\SalesChannelMaintenanceDisableCommand';
$classes[] = 'Shopware\Core\System\SalesChannel\Command\SalesChannelMaintenanceEnableCommand';
...
$classes[] = 'Shopware\Core\System\SalesChannel\Entity\SalesChannelApiController';
...
$classes[] = 'Shopware\Core\System\SalesChannel\SalesChannel\SalesChannelApiSchemaController';
$classes[] = 'Shopware\Core\System\SalesChannel\SalesChannel\SalesChannelContextController';
...
$classes[] = 'Shopware\Core\System\Snippet\Command\ValidateSnippetsCommand';
$classes[] = 'Shopware\Core\System\Snippet\SnippetValidator';
$classes[] = 'Shopware\Core\System\Snippet\SnippetFileHandler';
$classes[] = 'Shopware\Core\System\Snippet\SnippetFixer';
...
$classes[] = 'Shopware\Core\System\StateMachine\Command\WorkflowDumpCommand';
...
$classes[] = 'Shopware\Core\System\SystemConfig\Command\ConfigGet';
$classes[] = 'Shopware\Core\System\SystemConfig\Command\ConfigSet';
...
$classes[] = 'Shopware\Core\System\User\Command\UserChangePasswordCommand';
$classes[] = 'Shopware\Core\System\User\Command\UserCreateCommand';
$classes[] = 'Shopware\Core\System\User\Service\UserProvisioner';
$classes[] = 'Shopware\Core\System\User\UserDefinition';
$classes[] = 'Shopware\Elasticsearch\Framework\Command\ElasticsearchCleanIndicesCommand';
$classes[] = 'Shopware\Elasticsearch\Framework\ElasticsearchOutdatedIndexDetector';
$classes[] = 'Shopware\Elasticsearch\Framework\Command\ElasticsearchCreateAliasCommand';
$classes[] = 'Shopware\Elasticsearch\Framework\Command\ElasticsearchIndexingCommand';
$classes[] = 'Shopware\Elasticsearch\Framework\Command\ElasticsearchTestAnalyzerCommand';
...
$classes[] = 'Shopware\Production\Command\SystemGenerateAppSecretCommand';
$classes[] = 'Shopware\Production\Command\SystemGenerateJwtSecretCommand';
$classes[] = 'Shopware\Production\Command\SystemInstallCommand';
$classes[] = 'Shopware\Production\Command\SystemSetupCommand';
$classes[] = 'Shopware\Production\Command\SystemUpdateFinishCommand';
$classes[] = 'Shopware\Production\Command\SystemUpdatePrepareCommand';
...
$classes[] = 'Shopware\Storefront\Page\Product\ProductLoader';
$classes[] = 'Shopware\Storefront\Page\Product\CrossSelling\CrossSellingLoader';
$classes[] = 'Shopware\Storefront\Page\Product\QuickView\MinimalQuickViewPageLoader';
$classes[] = 'Shopware\Core\Content\Product\SalesChannel\ProductReviewService';
$classes[] = 'Shopware\Storefront\Controller\ProductExportController';
...
$classes[] = 'Shopware\Storefront\Event\BackwardSubscriber';
...
$classes[] = 'Shopware\Storefront\Framework\Cache\CacheDecorator';
...
$classes[] = 'Shopware\Storefront\Framework\Cache\CacheTagCollection';
...
$classes[] = 'Shopware\Storefront\Framework\Cache\ObjectCacheKeyFinder';
...
$classes[] = 'Shopware\Storefront\Framework\Command\HttpCacheWarmUpCommand';
$classes[] = 'Shopware\Storefront\Framework\Command\SalesChannelCreateStorefrontCommand';
...
$classes[] = 'Shopware\Storefront\Theme\Command\ThemeChangeCommand';
$classes[] = 'Shopware\Storefront\Theme\Command\ThemeCompileCommand';
$classes[] = 'Shopware\Storefront\Theme\Command\ThemeCreateCommand';
$classes[] = 'Shopware\Storefront\Theme\Command\ThemeDumpCommand';
$classes[] = 'Shopware\Storefront\Theme\Command\ThemeRefreshCommand';
...
$classes[] = 'Shopware\Core\Framework\Adapter\Asset\AssetInstallCommand';
...
$classes[] = 'Shopware\Core\Content\MailTemplate\Commands\AssignAllTemplatesToAllSalesChannelsCommand';
$classes[] = 'Shopware\Core\Content\ProductExport\Command\ProductExportGenerateCommand';
$classes[] = 'Shopware\Core\Content\Sitemap\Commands\SitemapGenerateCommand';
...
$classes[] = 'Shopware\Core\Framework\Api\Response\Type\SalesChannel\JsonApiType';
$classes[] = 'Shopware\Core\Framework\Api\Response\Type\Api\JsonType';
$classes[] = 'Shopware\Core\Framework\Api\Response\Type\SalesChannel\JsonType';
...
$classes[] = 'Shopware\Core\Content\MailTemplate\Service\MailerTransportFactory';
