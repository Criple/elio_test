...
class __TwigTemplate_e01407a557cf1fe2c5101a5d3f362aa4a307419c074629dee547150836e2662b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_layout_header_actions($context, array $blocks = [])
    {
        ...
        echo "
                        ";
        // line 76
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["shopware"] ?? null), "config", [], "any", false, false, false, 76), "core", [], "any", false, false, false, 76), "cart", [], "any", false, false, false, 76), "wishlistEnabled", [], "any", false, false, false, 76)) {
            // line 77
            echo "                            ";
